      ...
      <div className="inner_header_container">
        <div className="header_content_box">
          <ul>
            ...
            <li>
              <a href="https://sites.google.com/view/mark-treehouse-tech-degree" rel="noreferrer" target="_blank">
                <BiCertification className="banner_icons" />
              </a>
            </li>
            <li>
          ...
          <div className="get_in_tough_box">
            ...
            <a href="https://drive.google.com/file/d/102_0OcEK0ndyrmBeC_k0bJA93aX9sc3f/view?usp=sharing" rel="noreferrer" target="_blank" className="btn btn-smart">
              Download CV
            </a>
          </div>
        </div>
