...
const About = () => {
  const [about] = React.useState({
    subAbout: "About Me",
    text1:
      "I am a Full Stack Web Developer living in Italy, Europe. Am a creative and innovative Web Developer. I am interested in working on a team that develops real world projects.",
    text2:
